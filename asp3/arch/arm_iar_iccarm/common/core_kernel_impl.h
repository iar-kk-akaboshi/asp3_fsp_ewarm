 ...
 *  Copyright (C) 2005-2026 by Embedded and Real-Time Systems Laboratory
 ...
 *  の責任を負わない．
 *
 *  @(#) $Id: core_kernel_impl.h 1876 2026-02-27 08:36:39Z ertl-honda $
 */
 ...
 *  割込み要求禁止フラグのセット
 *
 *  この関数は，API中に呼び出すことを想定しているため，
 *  SCSの操作後にメモリ同期バリアを入れていない．
 */
Inline void
